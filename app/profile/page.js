      ...
      <div className="mt-6 grid gap-6 md:grid-cols-3">
        ...
        <div className="md:col-span-1">
          <div className="flex flex-col items-center gap-3 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <button className="rounded-md border border-blue-600 px-3 py-1.5 text-xs font-semibold text-blue-700 hover:bg-blue-50">
              Change
            </button>
          </div>
        </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                id="year"
                name="year"
                className="mt-2 w-full rounded-md border border-zinc-300 px-4 py-3 text-zinc-900 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100"
              >
